...
$string['colibriv2'] = 'Adobe Connect';
$string['colibriv2fieldset'] = 'Impostazioni Adobe Connect';
$string['colibriv2host'] = 'Organizzatore';
$string['colibriv2hostdescription'] = 'Un organizzatore assegna privilegi agli utenti, inizia e termina una riunione, oltre a poter agire come Relatore';
$string['colibriv2intro'] = 'Introduzione';
$string['colibriv2name'] = 'Nome della riunione';
$string['colibriv2participant'] = 'Partecipante';
$string['colibriv2participantdescription'] = 'Partecipa ad una riunione, ma non ne modifica le impostazioni';
$string['colibriv2presenter'] = 'Relatore';
$string['colibriv2presenterdescription'] = 'Il relatore di una riunione utilizza contenuti, condivide lo schermo del proprio computer, invia messaggi, modera domande, crea note, condivide audio e video ed invia contenuti tramite link web';
...
$string['colibriv2:meetingpresenter'] = 'Relatore';
$string['colibriv2:meetingparticipant'] = 'Partecipante';
$string['colibriv2:meetinghost'] = 'Organizzatore';
...
$string['nopresenterrole'] = 'Il ruolo Adobe Presenter non &egrave definito nel sistema: segnalate all\' amministratore il problema.'; // view.php 'error: error finding colibriv2presenter role'
