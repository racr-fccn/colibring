...
$string['admin_prefix'] = 'Admin Prefix';
$string['admin_prefix_desc'] = 'Unique institutional prefix';

$string['savebeforepresstestconnectionbutton'] = 'Please save the data below before using the Test Button.';

$string['colibriv2'] = 'COLIBRIv2';
$string['colibriv2fieldset'] = 'COLIBRIv2 Settings';
$string['colibriv2host'] = 'COLIBRIv2 Host';
$string['colibriv2hostdescription'] = 'The host can give other users privileges, start and stop a meeting in addition to what a persenter can do';
$string['colibriv2intro'] = 'Intro';
$string['colibriv2name'] = 'Meeting title';
$string['colibriv2participant'] = 'COLIBRIv2 Participant';
$string['colibriv2participantdescription'] = 'Can view, but cannot modify any of the meeting settings';
$string['colibriv2presenter'] = 'COLIBRIv2 Presenter';
$string['colibriv2presenterdescription'] = 'The presenter of a meeting and can present content, share a screen, send text messages, moderate questions, create text notes, broadcast audio and video, and push content from web links';
...
$string['modulename'] = 'COLIBRIv2';
$string['modulename_help'] = 'The COLIBRIv2 activity module integrates with COLIBRIv2 service provided by FCT|FCCN, the Portuguese NREN.';
$string['modulenameplural'] = 'COLIBRIv2';
...
$string['port'] = 'Port';
$string['port_desc'] = 'Port used to connect to COLIBRIv2';
...
$string['record_force_desc'] = 'Force all COLIBRIv2 meetings to be recorded.  This is a site wide effect and the COLIBRIv2 server must be restarted';
...
$string['conntestintro'] = '<p>A series of tests will be run to determine whether the COLIBRIv2 is ok.</p><p>COLIBRIv2 server please consult the MoodleDocs help page for this activity module <a href="{$a->url}">Help page</a></p>';
...
$string['colibriv2:meetingpresenter'] = 'Meeting Presenter';
$string['colibriv2:meetingparticipant'] = 'Meeting Particpant';
$string['colibriv2:meetinghost'] = 'Meeting Host';
$string['public'] = 'Public';
$string['private'] = 'Private';

// Error codes
$string['emptyxml'] = 'Unable to connect to the COLIBRIv2 Pro server at this time.  Please inform your Moodle administrator.';
$string['adminemptyxml'] = 'Unable to connect to the COLIBRIv2 Pro server at this time.  Click continue to proceed to the activity settings page and test the connection';
...
$string['nopresenterrole'] = 'error: error finding colibriv2presenter role';
$string['nomeeting'] = 'No meeting exists on the server';
$string['noinstances'] = 'There are no instances of colibriv2';
...
<p>For example if the COLIBRIv2 server domain was located at <b>http://adobe.connect.server/</b>
...
$string['pluginadministration'] = 'COLIBRIv2 Administration';
$string['pluginname'] = 'COLIBRIv2';
$string['modulename'] = 'COLIBRIv2';
